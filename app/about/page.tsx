        ...
        <div className="flex flex-col items-center md:items-start space-y-6">
          ...
          <div className="w-full space-y-3">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <a href="https://www.linkedin.com/in/jusuf-skopljak-81647338a" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-zinc-400 hover:text-cyan-400 transition-colors p-2 bg-zinc-900/50 rounded-lg border border-zinc-800/60">
              ...
              <a href="https://www.instagram.com/jusuf.skopljak" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-zinc-400 hover:text-cyan-400 transition-colors p-2 bg-zinc-900/50 rounded-lg border border-zinc-800/60">
              ...
              {/* Email (Lucide radi) */}
              <a href="mailto:jusufskopjak2605.email@gmail.com" className="flex items-center gap-3 text-zinc-400 hover:text-cyan-400 transition-colors p-2 bg-zinc-900/50 rounded-lg border border-zinc-800/60">
